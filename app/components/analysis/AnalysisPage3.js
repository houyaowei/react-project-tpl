...
class AnalysisPage3 extends React.Component {
    constructor(props){
        super(props);
        this.state={
            title:'一个月',
    ...
    componentDidUpdate(){
        ...
        var option1 = [{
            title: {
                text: `人员进出同比${this.state.title}分析`
            },
            tooltip: {},
            legend: {
                data:['默认','往期']
            ...
            title: {
                text: `人员进出环比${this.state.title}分析`
            },
            tooltip: {},
            legend: {
                data:['默认','周边','周边2']
            ...
            title: {
                text: `人员进出${this.state.title}波动分析`
            },
            tooltip: {},
            legend: {
            },
            ...
            title: {
                text: `流动人口${this.state.title}top5分析`
            },
            tooltip: {},
            legend: {
            },
    ...
    componentDidMount(){
        ...
        var option = [{
            ...
            title: {
                text: `人员进出${this.state.title}top5分析`
            },
            tooltip: {},
            legend: {
            },
