    ...
    constructor(props){
        ...
        this.columns = [
            ...
            }, 
            {
                title: '道闸位置',
                dataIndex: 'Place',
                render: (text, record) => this.renderColumns(text, record, 'Place'),
            },
            {
                title: '生产厂家',
                dataIndex: 'DZBM',
                render: (text, record) => this.renderColumns(text, record, 'DZBM'),
            },
            {
                title: '道闸型号',
                dataIndex: 'SBXLH',
                render: (text, record) => this.renderColumns(text, record, 'SBXLH'),
            },
            {
                title: '道闸已维护年限',
                dataIndex: 'SBXH',
                render: (text, record) => this.renderColumns(text, record, 'SBXH'),
            },
            {
                title: '备注',
                dataIndex: 'BZ',
        ...
        this.state = {
            data: [],  //
            dataSource : Mock_data.barrier_manage,
            count:5,
            pagination: {},
            loading: false,
            //modal弹窗
  ...
  render() {
    ...
    <div>
       <div className="searchbar">
            <form action="#">
                <label htmlFor="name" className="lable namelable">道闸设备ID</label>
                <input type="text" name="name" id="name" className="table-input nameinput"/>
                <label htmlFor="age" className="lable agelable">道闸位置</label>
                <input type="text" name="age" id="age" className="table-input ageinput"/>
                <label htmlFor="age" className="lable agelable">生产厂家</label>
                <input type="text" name="age" id="age" className="table-input ageinput"/>
                <label htmlFor="age" className="lable agelable">道闸已维护年限</label>
                <input type="text" name="age" id="age" className="table-input ageinput"/>
