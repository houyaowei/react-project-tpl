...
class Test extends React.Component {
    constructor(props){
        ...
        this.state = {
            data: [],  //
            dataSource : Mock_data.video_manage,
            count:5,
            pagination: {},
            loading: false,
            //modal弹窗
  ...
  render() {
    ...
    <div>
       <div className="searchbar">
            <form action="#">
                <label htmlFor="name" className="lable namelable">视频ID</label>
                <input type="text" name="name" id="name" className="table-input nameinput"/>
                <label htmlFor="age" className="lable agelable">名称</label>
                <input type="text" name="age" id="age" className="table-input ageinput"/>
                <label htmlFor="age" className="lable agelable">编码格式</label>
                <input type="text" name="age" id="age" className="table-input ageinput"/>
                <label htmlFor="age" className="lable agelable">视频大小</label>
                <input type="text" name="age" id="age" className="table-input ageinput"/>
