...
class Test extends React.Component {
    constructor(props){
        ...
        this.state = {
            data: [],  //
            dataSource : Mock_data.doorCard_Manage,
            count:5,
            pagination: {},
            loading: false,
            //modal弹窗
  ...
  render() {
    ...
    <div>
       <div className="searchbar">
            <form action="#">
                <label htmlFor="name" className="lable namelable">设备ID</label>
                <input type="text" name="name" id="name" className="table-input nameinput"/>
                <label htmlFor="age" className="lable agelable">位置</label>
                <input type="text" name="age" id="age" className="table-input ageinput"/>
                <label htmlFor="age" className="lable agelable">设备序列号</label>
                <input type="text" name="age" id="age" className="table-input ageinput"/>
                <label htmlFor="age" className="lable agelable">设备型号</label>
                <input type="text" name="age" id="age" className="table-input ageinput"/>
