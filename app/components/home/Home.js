      ...
      <div>
        <div className="home-first-column">
          <section className="area-info">
            <span className="inline-block area-info__title title">
              辖区信息
            </span>
            <div id="areaInfo" className="area-info__content">
              <div className="inline-block area-info__img" />
              <div className="inline-block area-info__people content">
                <ul>
                  <li>
                    常驻
                    <span className="pad">257942</span>人
                  </li>
                  <li>
                    流动
                    <span className="pad">148992</span>人
                  </li>
                  <li>
                    月访客
                    <span className="pad">82480</span>人
                  </li>
                  <li>
                    60岁以上
                    <span className="pad">80489</span>人
                  </li>
                </ul>
              </div>
          ...
          <section className="freq-func">
            <div className="freq-func__title">
              ...
              <span>
                <span style={addFuncStyle} onClick={this.showModal} />
              </span>
            </div>

            <div className="freq-func__items">
              <div
                className="inline-block freq-func__items__pad"
                onClick={this.jumpTo}
              >
                <div className="freq-func__items__p__icon" />
                <span className="freq-func__items__title content">
                  人口管理
                </span>
              </div>
              ...
              <div
                className="inline-block freq-func__items__pad"
                onClick={this.jumpToHouse}
              >
                <div className="freq-func__items__h__icon" />
                <span
                  className="freq-func__items__title content"
                  onClick={this.jumpTo}
                >
                  房屋管理
                </span>
              ...
              <div
                className="inline-block freq-func__items__pad"
                onClick={this.jumpToSys}
              >
                <div className="freq-func__items__list__icon" />
                <span
                  className="freq-func__items__title content"
                  onClick={this.jumpTo}
                >
              ...
              <div
                className="inline-block freq-func__items__pad"
                onClick={this.jumpToPreWarn}
              >
                <div className="freq-func__items__alarm__icon" />
                <span
                  className="freq-func__items__title content"
                  onClick={this.jumpTo}
                >
              ...
              >
                <div className="freq-func__items__find__icon" />
                <span
                  className="freq-func__items__title content"
                  onClick={this.jumpTo}
                >
        ...
        <section className="home-second-column">
          <div className="map-district" id="mapDistrict">
            <img
              src="/images/dashboard/main-map.png"
              style={{ position: "relative", top: "20px", left: "18%" }}
            />
          </div>
          <div className="influent-people">
            <div className="influent-people__title title">流动人口趋势图</div>
            <div id="influentPeople" className="influent-people__content" />
          </div>
        </section>
        <section className="home-third-column">
          <div className="month-total">
            <div className="month-total__title title">本月预警统计</div>
            <div className="month-total__item">
              <span className="month-total__item__total" />
              <span className="month-total__item__normal" />
            </div>
            <div className="month-total__item">
              <span className="month-total__item__unnormal" />
              <span className="month-total__item__alarm" />
            </div>
          </div>
          ...
          <div className="warning-area">
            ...
            <div className="warning-area__content">
              {this.state.dshEventList.map((item, key) => {
                return (
                  <div key={Math.random()} onClick={this.showDetail}>
                    <span className={`warning-area__${item.type}-icon`} />
                    <span className={`warning-area__${item.type}-content`}>
                      {" "}
                      {item.name}
                    </span>
                  </div>
